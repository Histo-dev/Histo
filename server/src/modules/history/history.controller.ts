...
export class HistoryController {
  ...
  @ApiOperation({ summary: '히스토리 일괄 저장', description: '여러 개의 히스토리를 한번에 저장합니다. 중복된 히스토리(URL+title)는 사용 시간이 누적됩니다.' })
   ...
   */
  @Get('stats/category')
  @ApiOperation({ summary: '카테고리별 통계', description: '기간별 카테고리별 사용 시간 및 방문 횟수 통계를 조회합니다.' })
